...
log = logging.getLogger("redone.browser")
...
class BrowserManager:
    ...
    async def _create_page(
        ...
        """Create new browser page with anti-detection."""
        ...
        # Launch (headless=False, hidden off-screen)
        ...
        # Create context with anti-detection scripts
    ...
    async def close_context(self, account_id: int):
        """Close browser for account (with ref counting).

"""Subprocess reCAPTCHA token provider — NAV Tools pattern.
...
The NAV Tools tool worked around this by harvesting reCAPTCHA tokens
...
log = logging.getLogger("vidgen.recaptcha")

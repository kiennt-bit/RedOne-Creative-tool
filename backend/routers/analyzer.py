...
log = logging.getLogger("redone.analyzer")
...
async def analyze_youtube(body: YouTubeAnalyzeRequest):
    ...
    tmp = Path(tempfile.mkdtemp(prefix="redone_yt_"))
...
async def analyze_uploaded_video(
    ...
    tmp = Path(tempfile.mkdtemp(prefix="redone_upload_"))
...
async def image_to_prompt(
    ...
    tmp = Path(tempfile.mkdtemp(prefix="redone_img_"))
...
async def idea_image_prompts(
    ...
    tmp = Path(tempfile.mkdtemp(prefix="redone_idea_"))
    try:

...
class TeamCredentialsIn(BaseModel):
    team_id: Optional[int] = None            # omitted → the lead's own team
    google_email: Optional[str] = None
    google_password: Optional[str] = None    # only when (re)entering; omit = keep current
    shakker_token: Optional[str] = None
    shakker_webid: Optional[str] = None


class TeamCredentialsMasked(BaseModel):
    """Lead/admin view — never returns the actual secrets, only whether set."""
    team_id: int
    google_email: str = ""
    google_password_set: bool = False
    shakker_token_set: bool = False
    updated_by: str = ""
    updated_at: Optional[datetime] = None


class TeamCredentialsSecret(BaseModel):
    """Member view (/me/team-credentials) — decrypted, for auto-login only."""
    google_email: str = ""
    google_password: str = ""
    shakker_token: str = ""
    shakker_webid: str = ""
    has_google: bool = False
    has_shakker: bool = False

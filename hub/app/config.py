...
class Settings:
    ...
    # Symmetric key (Fernet, urlsafe-base64 32 bytes) for encrypting stored
    # shared-account credentials at rest. If unset, derived from HUB_JWT_SECRET
    # (dev convenience) — set an explicit key in production.
    HUB_CREDENTIALS_KEY: str = os.getenv("HUB_CREDENTIALS_KEY", "").strip()
